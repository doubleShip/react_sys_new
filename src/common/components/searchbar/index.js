...
export default class SearchBar extends React.Component {
  ...
  generateInputs(fields) {
    ...
    for (const field of fields) {
      ...
      components.push(<div key={i++} className="searchbar-field">
        <div className="input-box">
          <div className="title" style={{ width: field.labelWidth }}>{field.title}:</div>
          <div className="input" style={{ width: field.width || FIELD_INPUT_WIDTH }}>{component}</div>
        </div>
  ...
  render() {
    return (
      <div className="searchbar">
        ...
        <div className="searchbar-buttonGroup">
